...
VL_INLINE_OPT void Vconv1___024root___sequent__TOP__2(Vconv1___024root* vlSelf) {
    ...
    if (vlSelf->cnn_data_in_valid) {
        ...
        if ((0x13U >= (IData)(vlSelf->conv1__DOT__wr_addr))) {
    ...
    if ((0x13U >= (IData)(vlSelf->conv1__DOT__rd_addr))) {
...
VL_INLINE_OPT void Vconv1___024root___sequent__TOP__3(Vconv1___024root* vlSelf) {
    ...
    if (vlSelf->rst_n) {
        if ((((0x13U == (IData)(vlSelf->conv1__DOT__x_cnt)) 
    ...
    if (vlSelf->rst_n) {
        if (((((0x13U == (IData)(vlSelf->conv1__DOT__y_cnt)) 
               & (0x13U == (IData)(vlSelf->conv1__DOT__x_cnt))) 
              & (IData)(vlSelf->cnn_data_in_valid)) 
             & (IData)(vlSelf->img_in_en))) {
    ...
    if (vlSelf->rst_n) {
        if (((IData)(vlSelf->cnn_data_in_valid) & (IData)(vlSelf->img_in_en))) {
            __Vdly__conv1__DOT__wr_addr = ((0x13U == (IData)(vlSelf->conv1__DOT__wr_addr))
                                            ? 0U : 
                                           (0x1fU & 
                                            ((IData)(1U) 
